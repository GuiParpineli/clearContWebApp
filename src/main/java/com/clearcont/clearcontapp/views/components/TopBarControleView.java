...
public class TopBarControleView extends FlexLayout {
    ...
    private void getCompany(@NotNull EmpresaRepository empresaRepository, @NotNull Consumer<Empresa> callback) {
    ...
    private void getMonth(@NotNull Consumer<String> callback) {
    ...
    public TopBarControleView(@NotNull ControleService controleService, @NotNull EmpresaRepository empresaRepository) {
